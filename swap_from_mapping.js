...
const SLIPPAGE_TOLERANCE = 0.02; // 2% for safety
...
async function main() {
  ...
  // Debug: Check wallet balance and allowance
  ...
  const amountOutMinimum = amountOut.mul(100 - (SLIPPAGE_TOLERANCE * 100)).div(100);
